...
public class TrifidCipher {
	...
	public static void main(String[] args) {
		...
		System.out.println(triMy.criptare("ANAAREMERE", "ALEXNDRUBCFGHIJKMOPQSTVWYZ.", 5));
		System.out.println(triMy.decriptare("AACQAXASUS", "ALEXNDRUBCFGHIJKMOPQSTVWYZ.", 5));

	}
	public String criptare(String userInput, String key) {
		return "";
	}
	public String decriptare(String userInput, String key) {
		return "";
	}


	public String criptare(String userInput, String key, int keyS) {
	...
	public String decriptare(String userInput, String key, int keyS) {
		int keySize = keyS;
